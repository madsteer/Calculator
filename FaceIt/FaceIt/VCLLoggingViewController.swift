...
//  FaceIt
//
//  Created by Cory Steers on 6/29/17.
...
class VCLLoggingViewController: UIViewController {
    ...
    private static func bumpInstatnceCount(for className: String) -> Int {
    ...
    private func logVCL(_ msg: String) {
        ...
        if instanceCount == nil {
            instanceCount = VCLLoggingViewController.bumpInstatnceCount(for: className)
        }
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        logVCL("init(coder:) = created vial InterfaceBuilder ")
    }
    ...
    override func viewWillLayoutSubviews() {
        ...
        logVCL("viewWillLayoutSubviews() bouinds.size = \(view.bounds.size)")
    }
    
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
        logVCL("viewDidLayoutSubviews() bouinds.size = \(view.bounds.size)")
    }
